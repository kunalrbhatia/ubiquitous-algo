...
exports.updateMaxSl = exports.setSmartSession = exports.setCred = exports.isTradeAllowed = exports.isMarketClosed = exports.isCurrentTimeGreater = exports.getLotSize = exports.getLastThursdayOfCurrentMonth = exports.getAtmStrikePrice = exports.findNearestStrike = exports.delay = void 0;
...
var setCred = exports.setCred = function setCred(req) {
  var creds = {
...
var updateMaxSl = exports.updateMaxSl = function updateMaxSl(_ref) {
  var mtm = _ref.mtm,
    maxSl = _ref.maxSl,
...
var delay = exports.delay = function delay(_ref2) {
...
var setSmartSession = exports.setSmartSession = function setSmartSession(data) {
  var smartData = {
...
var isMarketClosed = exports.isMarketClosed = function isMarketClosed() {
...
var isTradeAllowed = exports.isTradeAllowed = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var isMarketOpen, hasTimePassedToTakeTrade, isSmartAPIWorking, smartData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          isMarketOpen = !isMarketClosed();
          hasTimePassedToTakeTrade = isCurrentTimeGreater({
            hours: 9,
            minutes: 15
          });
          ...
          _context.prev = 3;
          _context.next = 6;
          return (0, _apiService.generateSmartSession)();
        case 6:
          smartData = _context.sent;
        ...
        case 13:
          return _context.abrupt("return", isMarketOpen && hasTimePassedToTakeTrade && isSmartAPIWorking);
        case 14:
        case "end":
  ...
  return function isTradeAllowed() {
    return _ref3.apply(this, arguments);
  };
}();
var isCurrentTimeGreater = exports.isCurrentTimeGreater = function isCurrentTimeGreater(_ref4) {
...
var getLastThursdayOfCurrentMonth = exports.getLastThursdayOfCurrentMonth = function getLastThursdayOfCurrentMonth() {
...
var findNearestStrike = exports.findNearestStrike = function findNearestStrike(options, target) {
...
var getAtmStrikePrice = exports.getAtmStrikePrice = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref5) {
    var scrip, ltp, expiryDate, optionChain;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          scrip = _ref5.scrip, ltp = _ref5.ltp;
          expiryDate = getLastThursdayOfCurrentMonth();
          _context2.prev = 2;
          _context2.next = 5;
          return (0, _apiService.getOption)({
            scriptName: scrip.name,
            expiryDate: expiryDate
          });
        case 5:
          optionChain = _context2.sent;
          if (!(typeof ltp === 'number' && !isNaN(ltp))) {
            _context2.next = 10;
            break;
          }
          return _context2.abrupt("return", findNearestStrike(optionChain, ltp));
        case 10:
        ...
        case 13:
          ...
          console.error("".concat(_constants.ALGO, ": Error - ").concat(_context2.t0));
          throw _context2.t0;
        case 17:
        case "end":
  ...
  return function getAtmStrikePrice(_x) {
    return _ref6.apply(this, arguments);
  };
}();
var getLotSize = exports.getLotSize = function getLotSize(_ref7) {
  var scrip = _ref7.scrip;
  var lotsize = (0, _lodash.get)(scrip, 'lotsize');
  if (typeof lotsize === 'string' && !(0, _lodash.isEmpty)(lotsize)) {
